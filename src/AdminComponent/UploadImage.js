...
export const UploadImageCreate = (props) => {
  ...
  console.log("🚀 ~ file: UploadImage.js ~ line 70 ~ UploadImageCreate ~ location", location)
  const product_id = location.state?.defaultProductId;
  console.log("🚀 ~ file: UploadImage.js ~ line 72 ~ UploadImageCreate ~ product_id", product_id)
